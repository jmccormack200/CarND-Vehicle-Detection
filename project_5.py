...
def get_hog_features(img, orient, pix_per_cell, cell_per_block, vis=False, feature_vec=True):
    if vis == True:
        ...
        features = features = hog(img, orientations=orient, pixels_per_cell=(pix_per_cell, pix_per_cell),
                       cells_per_block=(cell_per_block, cell_per_block), transform_sqrt=False,
...
class VehicleFinder:
    ...
    def __init__(self,
        ...
        self.heat_map_buffer = HeatMapBuffer()
    ...
    def find(self, image):
        ...
        hot_windows = search_windows(draw_image, slided_windows, self.svc, self.X_scaler,
        ...
        #return draw_boxes(draw_image, hot_windows, color=(255, 255, 255), thick=6)
        return draw_img
